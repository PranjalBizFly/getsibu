...
/**
 * Every live canonical page and hub, plus indexable company pages. Merged duplicates, held pages,
 * redirects and noindex pages are excluded by construction; scripts/verify-build.ts checks the output.
 */
